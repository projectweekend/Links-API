...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Maker.joined'
        db.add_column(u'maker_maker', 'joined',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 3, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Maker.joined'
        db.delete_column(u'maker_maker', 'joined')
    ...
    models = {
        ...
        u'maker.passwordresettoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'acce3218-fcfa-4520-8275-da57c12fcb15'", 'max_length': '50'})
        }
    }
