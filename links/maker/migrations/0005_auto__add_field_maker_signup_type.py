...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Maker.signup_type'
        db.add_column(u'maker_maker', 'signup_type',
                      self.gf('django.db.models.fields.CharField')(default='RG', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Maker.signup_type'
        db.delete_column(u'maker_maker', 'signup_type')
    ...
    models = {
        ...
        u'maker.passwordresettoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'be5f572b-8572-4a86-947d-d6c05be95d12'", 'max_length': '50'})
        }
    }
