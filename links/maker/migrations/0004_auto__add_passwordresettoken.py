...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'maker_passwordresettoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('maker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maker.Maker'])),
            ('token', self.gf('django.db.models.fields.CharField')(default='eed5f4e3-2522-4d7b-9ae2-6568d618da89', max_length=50)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'maker', ['PasswordResetToken'])


    def backwards(self, orm):
        # Deleting model 'PasswordResetToken'
        db.delete_table(u'maker_passwordresettoken')
    ...
    models = {
        ...
        u'maker.passwordresettoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'51d4d7ea-edb4-4d4b-97d2-f881d56756dd'", 'max_length': '50'})
        }
    }
