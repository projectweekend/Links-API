...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailChangeToken.new_email'
        db.add_column(u'maker_emailchangetoken', 'new_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailChangeToken.new_email'
        db.delete_column(u'maker_emailchangetoken', 'new_email')
    ...
    models = {
        ...
        u'maker.emailchangetoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'59dcaaf5-9e71-4487-ba61-18f88d180810'", 'max_length': '50'})
        },
        u'maker.maker': {
        ...
        u'maker.passwordresettoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'maker': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['maker.Maker']"}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'18453b59-5531-4231-93a9-b5b2b1444e15'", 'max_length': '50'})
        }
    }
