...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Folder', fields ['owner', 'name']
        db.create_unique(u'folder_folder', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Folder', fields ['owner', 'name']
        db.delete_unique(u'folder_folder', ['owner_id', 'name'])
