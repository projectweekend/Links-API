...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'link_link', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maker.Maker'])),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['folder.Folder'], null=True)),
    ...
    models = {
        ...
        u'link.link': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'folder': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['folder.Folder']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
